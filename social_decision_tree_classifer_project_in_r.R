#Here we will be using Decision Tree CLASSIFICATION in R
...
#Here we are fitting DTC to the Training set
#First we import the rpart library
library(rpart)

#Now we set up our DTC classifier
